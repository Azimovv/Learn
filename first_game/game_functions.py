...
import pygame
from first_game.bullet import Bullet
from first_game.alien import Alien
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb,
                                 ship, aliens, bullets):
    """Respond tp bullet-alien collisions"""
...
def check_aliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # Treat this the same as if the ship had got hit
